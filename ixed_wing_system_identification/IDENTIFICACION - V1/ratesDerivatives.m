...
load simulationData
% filter setup
optimal_windowSize_q = optimalFiltering(q_meas,q,tout);
...
optimal_windowSize_p = optimalFiltering(p_meas,p,tout);
% filter setup
...
% --------------------------------------------------------------------- %
%% filter analysis -> FIND THE BEST WINDOW SIZE FOR THE FILTER
optimal_windowSize_r = optimalFiltering(r_meas,r,tout);
